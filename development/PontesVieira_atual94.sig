...
<sc version="201503" id="94" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" EPICSTimeHorizon="100000" EPICSLogLevel="3" interstagesUsingMinDurations="true" checkSum="2461130972">
  <signaldisplays>
  ...
  <sgs>
    <sg id="9413" name="DesMoreira" defaultSignalSequence="7" underEPICSControl="true">
      <defaultDurations>
    ...
    <sg id="9424" name="PV" defaultSignalSequence="7" underEPICSControl="true">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="3" duration="5000" />
        <defaultDuration display="4" duration="4000" />
  ...
  <progs>
    <prog id="1" cycletime="160000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Plano1">
      <sgs>
        <sg sg_id="9413" signal_sequence="7">
          <cmds>
            <cmd display="3" begin="102000" />
            <cmd display="1" begin="149000" />
          </cmds>
          <fixedstates>
            <fixedstate display="4" duration="4000" />
          </fixedstates>
        </sg>
        <sg sg_id="9424" signal_sequence="7">
          <cmds>
            <cmd display="3" begin="9000" />
            <cmd display="1" begin="99000" />
          </cmds>
          <fixedstates>
            <fixedstate display="4" duration="4000" />
          </fixedstates>
