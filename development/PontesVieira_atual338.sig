...
<sc version="201503" id="338" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" EPICSTimeHorizon="100000" EPICSLogLevel="3" interstagesUsingMinDurations="true" checkSum="2287009015">
  <signaldisplays>
  ...
  <sgs>
    <sg id="3381" name="Norte" defaultSignalSequence="7" underEPICSControl="true">
      <defaultDurations>
    ...
    <sg id="33823" name="Leste-Oeste" defaultSignalSequence="7" underEPICSControl="true">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="3" duration="5000" />
        <defaultDuration display="4" duration="4000" />
  ...
  <progs>
    <prog id="1" cycletime="160000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Plano1">
      <sgs>
        <sg sg_id="3381" signal_sequence="7">
          <cmds>
            <cmd display="1" begin="8000" />
            <cmd display="3" begin="110000" />
          </cmds>
          <fixedstates>
            <fixedstate display="4" duration="4000" />
          </fixedstates>
        </sg>
        <sg sg_id="33823" signal_sequence="7">
          <cmds>
